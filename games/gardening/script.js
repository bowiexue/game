window.BONSAI_REGISTRY = {
    "pine": {
        ...
        stages: {
            ...
            // MATCHES USER IMAGE 1: Perfectly balanced, blocky winding trunk with multi-shade green canopy layers
    ...
    "sakura": {
        ...
        stages: {
            ...
            // MATCHES USER IMAGE 2: Elegant stacked tiered pastel pink blocks sitting on your custom brown pot base
            mature: `<svg viewBox="0 0 32 32"><rect x="15" y="7" width="2" height="2" fill="#8B0000"/><rect x="8" y="9" width="16" height="4" fill="#FBCce3"/><rect x="10" y="13" width="12" height="3" fill="#F4A2C4"/><rect x="12" y="16" width="8" height="3" fill="#E87FA7"/><rect x="15" y="19" width="2" height="5" fill="#6E473B"/><rect x="9" y="24" width="14" height="6" fill="#A0785C"/><rect x="10" y="30" width="12" height="1" fill="#78543C"/></svg>`
        }
    },
    "bamboo": {
