...
window.components.proteins.forEach(b => {
    window.components.grains.forEach(s => {
        window.components.liquids.forEach(l => {
            let sortKey = [b, s, l].sort().join(',');
            if (!window.recipeBook[sortKey]) {
                window.recipeBook[sortKey] = {
